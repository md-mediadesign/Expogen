...
function buildPreviewH() {
  ...
  <div class="tl-page h-page" style="background:${T.warm};display:flex;flex-direction:column;justify-content:flex-end;position:relative;overflow:hidden">
    ...
    <!-- Lesbarkeits-Verlauf (Akzent/Balkenfarbe, 0% oben → 30% unten am Balken) -->
    <div style="position:absolute;left:0;right:0;bottom:0;height:55%;background:linear-gradient(180deg, ${acc}00 0%, ${acc}4D 100%);pointer-events:none;z-index:1"></div>
