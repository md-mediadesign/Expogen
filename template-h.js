...
function buildPreviewH() {
  ...
  <div class="tl-page h-page" style="background:${T.warm};display:flex;flex-direction:column;justify-content:flex-end;position:relative;overflow:hidden">
    ...
    <!-- Lesbarkeits-Verlauf (dunkler Braunton, 100% am Balken → 0% über Headline) -->
    <div style="position:absolute;left:0;right:0;bottom:0;height:55%;background:linear-gradient(to top, rgba(78,63,40,1) 0%, rgba(78,63,40,1) 18%, rgba(78,63,40,0) 100%);pointer-events:none;z-index:1"></div>
        ...
        ${has360
          ? `<div style="margin-top:auto;display:flex;align-items:center;gap:12px">
              ...
              <div style="display:flex;flex-direction:column;gap:6px;min-width:0">
                <div style="font-size:11px;font-weight:400;letter-spacing:.04em;color:${T.parch};line-height:1.45">QR scannen<br>& Tour starten</div>
                <a href="${esc(d.link360)}" target="_blank" style="font-size:11px;font-weight:400;letter-spacing:.04em;color:${T.parch};text-decoration:none;border-bottom:1px solid ${T.parch}66;padding-bottom:2px;align-self:flex-start">Zum Rundgang →</a>
              </div>
            </div>`
